...
func (x *LogInfoResp) GetOpTime() string {
	if x != nil {
		return x.OpTime
	}
	return ""
...
func (x *LogInfoResp) GetCreateTime() string {
	if x != nil {
		return x.CreateTime
	}
	return ""
...
var file_openchat_admin_admin_proto_rawDesc = []byte{
	...
	0x70, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x70, 0x54,
