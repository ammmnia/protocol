...
type CheckUserAddFriendReq struct {
	...
	CheckUserID string `protobuf:"bytes,1,opt,name=checkUserID,proto3" json:"checkUserID,omitempty"`
}
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x6b, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63,
